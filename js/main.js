let API = "http://localhost:8001/movies"
...
function movieCard (movie){
    return`
    <div class="card col-4 mt-30 mx-3 mb-3" style="width: 17rem">
    <img src="${movie.img}" class="card-img-top movie-img" alt="...">
    <h4>Name: ${movie.price}</h4>
    <h4 class="card-title">Surname: ${movie.title}</h4>
    <div class="card-body">
    <h6 class="card-text">Description: ${movie.desc}</h6>
